...
const dates = [
  { icon: FileText,    label: 'Recepción de ponencias',    date: '25 de agosto de 2026',    emphasis: true },
  { icon: CheckCircle, label: 'Notificación de resultados', date: '30 de septiembre de 2026', emphasis: false },
  { icon: Calendar,    label: 'Evento virtual sincrónico',  date: '11 de octubre de 2026',   emphasis: false },
];
