...
export const metadata = {
  ...
  description: 'Foro Regional sobre Tecnologías del Aprendizaje con Inteligencia Artificial. 15 de octubre 2026. Universidad Juárez Autónoma de Tabasco.',
  ...
  openGraph: {
    ...
    description: 'Foro Regional sobre Tecnologías del Aprendizaje con Inteligencia Artificial. 15 de octubre 2026. UJAT DACyTI.',
    images: ['/og-image.png'],
  },
};
