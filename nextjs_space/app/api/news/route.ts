...
const STATIC_NEWS = [
  {
    ...
    content: 'El comité organizador del Foro Regional TAC-IA anuncia la apertura oficial de la convocatoria para el evento que se realizará el 11 de octubre de 2026 en modalidad virtual sincrónica. Invitamos a investigadores, docentes y estudiantes de la región Sur-Sureste a participar.',
